...
int main()
{
    ComplexMath::Complexo complexo1(6,8);
    ComplexMath::Complexo complexo2(3,4);
    cout << "numero1:" << complexo1.toString() << endl;
    cout << "numero2:" << complexo2.toString() << endl;

    cout << endl << "Forma 1:" << endl;

    ComplexMath::Complexo complexo3 = ComplexMath::soma(&complexo1,&complexo2);
    cout << "numero1 + numero2 =" << complexo3.toString() << endl;

    complexo3 = ComplexMath::subtracao(&complexo1,&complexo2);
    cout << "numero1 - numero2 =" << complexo3.toString() << endl;

    complexo3 = ComplexMath::multiplicacao(&complexo1,&complexo2);
    cout << "numero1 x numero2 =" << complexo3.toString() << endl;

    complexo3 = ComplexMath::divisao(&complexo1,&complexo2);
    cout << "numero1 / numero2 =" << complexo3.toString() << endl;

    cout << endl<< "Forma 2:" << endl;

    cout << "numero1 + numero2 =" << ComplexMath::soma(&complexo1,&complexo2).toString() << endl;
    cout << "numero1 - numero2 =" << ComplexMath::subtracao(&complexo1,&complexo2).toString() << endl;
    cout << "numero1 x numero2 =" << ComplexMath::multiplicacao(&complexo1,&complexo2).toString() << endl;
    cout << "numero1 / numero2 =" << ComplexMath::divisao(&complexo1,&complexo2).toString() << endl;
